...
class PgKnexCrudStrategy extends PgCrudStrategy {
   ...
   */
    ...
    getInfoForBarChartDatediff (fromModel, fromDataTypeId, fromFieldName, fromHasSample,
        ...
        if (joinSample) {
            if (fromHasSample == 1) {
                ...
                query.leftOuterJoin(joinSample.name + " as " + joinSample.alias, joinSample.alias + "." + joinSample.parentColumn, toMdAlias + ".id");
                query.leftOuterJoin("sample", joinSample.alias + "." + joinSample.parentColumn, "sample.id");
            }
        }
