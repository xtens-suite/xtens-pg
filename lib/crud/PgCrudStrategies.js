...
class PgKnexCrudStrategy extends PgCrudStrategy {
    ...
    createData(data, dataTypeName) {
        ...
        .then(function(inserts) {
            ...
            _.each(createData.files, console.log);
    ...
    updateData(data, dataTypeName) {
        let idData, that = this, knex = this.knex;
        ...
        return knex.transaction(function(trx) {
            ...
            .then(function(idsUpdated) {
                idData = idsUpdated[0];
                console.log("KnexStrategy.updateData - data instance updated for ID: " + idData);
    ...
    createSample(sample, sampleTypeName) {
        ...
        return knex.transaction(function(trx) {
            ...
            .then(function(lastSample) {
                ...
                let lastBiobankCode = _.parseInt(lastSample.biobank_code);
                let nextCode = _.isNaN(lastBiobankCode) ? '08001' : '0' + (lastBiobankCode + 1);
            ...
            .then(function(ids) {
                idSample = ids[0];
                console.log("KnexStrategy.createData - data instance created with ID: " + idSample);
                return that.handleFiles(files, idSample, sampleTypeName, trx, 'sample');
