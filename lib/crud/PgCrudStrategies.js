...
class PgKnexCrudStrategy extends PgCrudStrategy {
    ...
    updateData(data, dataTypeName) {
        let that = this, knex = this.knex, updatedData, existingFiles, notExistingFiles;
        [existingFiles, notExistingFiles] = _.partition(data.files, file => {
            return !file.id;
        });
        /*
    ...
    updateSample(sample, sampleTypeName) {
        let that = this, knex = this.knex, updatedSample, existingFiles, notExistingFiles;
        [existingFiles, notExistingFiles] = _.partition(sample.files, file => {
            return !file.id;
        });
        /*
        ...
        return knex.transaction(function(trx) {
            ...
            .then(function(rows) {
                ...
                console.log("KnexStrategy.createData - data instance created with ID: " + updatedSample.id);
            ...
            .then(function() {
                ...
                sample.files = existingFiles.concat(notExistingFiles);
            });
