...
class PgKnexCrudStrategy extends PgCrudStrategy {
   ...
   */
    ...
    getInfoForBarChartDatediff (fromModel, fromDataTypeId, fromFieldName, fromDataTypeByPt,
        ...
        if (in_array('sample', [fromModel, toModel])) {
            //query.select("sample.biobank_code as biobank_code");
        } else {
            //query.select("null as biobank_code");
        }
        query.select(fromField + " as fromDate");
        query.select(toField + " as toDate");
        query.from("subject");
        ...
        query.innerJoin(fromModel + " as " + fromMdAlias, function() {
            this.on(fromMdAlias + ".id", "=", joinFrom.childColumn)
        ...
        query.leftOuterJoin(toModel + " as " + toMdAlias, function() {
            this.on(toMdAlias + ".id", "=", joinTo.childColumn)
