...
class PgKnexCrudStrategy extends PgCrudStrategy {
    ...
    findData(criteria) {
        ...
        switch (criteria.model) {
            case "Data":
                query = knex.select('data.id', 'data.type', 'data.metadata', 'data_type.project', 'data_type.name', 'datatype_privileges.privilege_level', 'data.notes', 'data.tags', 'data.parent_subject', 'data.parent_data', 'data.parent_sample', 'data.acquisition_date as date', 'data.created_at', 'data.updated_at').from('data');
            ...
            case "Subject":
                ...
                if (criteria.canAccessPersonalData) {
                    query.select('personal_details.given_name', 'personal_details.surname', 'personal_details.birth_date', 'personal_details.id as pd_id');
