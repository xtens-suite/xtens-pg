...
class PgCrudManager {
    ...
    getInfoForBarChartDatediff (fromModel, fromDataTypeId, fromFieldName, toModel, toDataTypeId, toFieldName, period, next) {
        return this.strategy.getInfoForBarChartDatediff (fromModel, fromDataTypeId, fromFieldName, toModel, toDataTypeId, toFieldName, period, next);
    }
}
